...
INSTALLATION
============
1.  Latest version of the zipped file for this plug is available from https://github.com/bencellis/moodle-mod_slideshare
...
5.  Ensure that the folder has the same permissions and owner as the other folders in the directory -
    ...
    1.  chown -R apache:apache slideshare
    2.  chmod -R 755 slideshare
...
3.  Delete the relevant folder /mod/slideshare from the moodle root e.g. /var/www/html/mod/slideshare then select Continue in the browser.
