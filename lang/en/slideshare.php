...
/**
 * English strings for slideshare
 *
...
$string['pluginname'] = 'slideshare Snippet';
$string['pluginadministration'] = $string['pluginname'] . ' Administration';
$string['modulename'] = 'slideshare Snippet';
$string['modulenameplural'] = 'slideshare Snippets';
$string['modulename_help'] = 'The slideshare module allows course managers to include fragments of slideshare pages';
$string['slideshare'] = 'slideshare';
$string['noslideshares'] = 'No slideshare snippets found';
...
$string['ws_formsection'] = 'slideshare Snippet Settings';
$string['wikis_url'] = 'slideshare URL';
$string['wikis_url_help'] = 'including fragment #anchor <br/> enter #toc for Table of Contents, #preamble for the introductory text and #infobox for the information table on the slideshare page';
$string['wikis_excludeImages'] = 'No Images?';
$string['wikis_excludeImages_help'] = 'Select so that images on the slideshare page are stripped out';
$string['wikis_excludeLinks'] = 'No Links?';
$string['wikis_excludeLinks_help'] = 'Select so that any internal links on the slideshare page are stripped out - leaving the text';
